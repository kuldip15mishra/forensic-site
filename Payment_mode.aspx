<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Payment_mode.aspx.cs" Inherits="Payment_mode" %>
  ...
  <div id="container_sub">
    ...
    <div id="center_div">
      <div id="left_colum_main">
        <div class="about_heading">Payment Mode</div>
        <div class="left_colum">
          <table width="709" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="25" colspan="2" align="left" class="pera_heading_sub">Bank Details</td>
            </tr>
            <tr>
              <td width="17" align="center" valign="top">&nbsp;</td>
              <td width="692" align="left" valign="baseline"><strong>Payment Mode : Online Transfer/Cash Deposit/Cheque</strong><br />
Bank Name- <strong>State Bank of India</strong><br />
Acc. Name- Syed Faisal Huda and Syed Faizal Huda<br />
Account No - 30948549631<br />
Branch. Civil, Lines near katchery, Bareilly, Uttar Pradesh<br />
IFSC Code: SBIN0000615<br />
<br />

*Cheque should be in the favour of Syed Faisal Huda or Syed Faizal Huda*
<strong><br />
              </strong></td>
            </tr>
          </table>
